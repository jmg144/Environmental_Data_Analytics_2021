...
NTL.phys.data.TuesdayLake <- filter(NTL.phys.data, year4 == 1999)
...
July.TuesdayLake.NTL.phys.data <- NTL.phys.data %>%
...
NTL.phys.data.gathered <-pivot_longer(NTL.phys.data, tn_ug:po4, names_to = "irradianceWater", values_to = "irradianceDeck")
